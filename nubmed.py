...
st.markdown("<h1 style='text-align: center; color: black ; font-size: 30px ;'><em>App นับเม็ด</em></h1>", unsafe_allow_html=True)
...
col1c1, col2c1, col3c1, col4c1, col5c1, col6c1, col7c1, col8c1 = st.columns([0.6,0.6,1,0.7,0.5,1,1.3,1])
